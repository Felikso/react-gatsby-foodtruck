...
function HeroContact() {
    return (
        ...
        <HeroContactContainer>
            <HeroContactBg><StyledBackgroundHeroContactSection />
...
const HeroContactBg = styled.div`
    position: absolute;
    top: 0;
    bottom: 0;
    right: 0;
...
const HeroContactContent = styled.div`
    z-index: 3;
...
const HeroContactItems = styled.div`
    display: flex;
